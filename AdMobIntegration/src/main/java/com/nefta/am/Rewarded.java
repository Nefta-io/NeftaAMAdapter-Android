...
public class Rewarded extends TableLayout {
    private final String AdUnitA = "ca-app-pub-1193175835908241/8841990779";
    private final String AdUnitB = "ca-app-pub-1193175835908241/7205661812";
    ...
    private class Track extends FullScreenContentCallback implements OnPaidEventListener, OnUserEarnedRewardListener {
    ...
    private void GetInsightsAndLoad(Track track) {
        ...
        NeftaPlugin._instance.GetInsights(Insights.REWARDED, track._insight, (Insights insights) -> {
            ...
            if (insights._rewarded != null) {
                ...
                RewardedAd.load(_activity, track._adUnitId, track._request, track._loadCallbacks);
            } else {
                track.AfterLoadFail();
            }
        });
